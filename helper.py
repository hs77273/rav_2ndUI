...
class objectsFiles:
    def __init__(self):
        ...
        self.filter = ("dining table","window","desk","toilet","door","tv","microwave","oven","toaster","sink","refrigerator","chair","couch","potted plant","bed","kite","cow","elephant","bear","zebra","giraffe","horse","sheep","boat","traffic light","fire hydrant","street sign","stop sign","parking meter","bench","car","motorcycle","airplane","bus","train","truck","person","bicycle","tie","bird","cat","dog","pizza","teddy bear","vase","frisbee","toothbrush","donut","cake","bowl","banana","snowboard","skateboard","baseball glove","sports ball","hot dog","pizza","apple","sandwich","orange","broccoli","carrot","wine glass","tennis racket")
        self.offensive_objects = ("scissors","knife","baseball bat","fork","pistol")
        self.yolov5path = 'CocoModel/yolov5s.pt'
